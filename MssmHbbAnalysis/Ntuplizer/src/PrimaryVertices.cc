...
PrimaryVertices::PrimaryVertices(const edm::InputTag& tag, TTree* tree)
{
...
void PrimaryVertices::ReadFromEvent(const edm::Event& event)
{
   using namespace edm;
...
void PrimaryVertices::Candidates()
{
   using namespace edm;
...
void PrimaryVertices::Fill()
{
   tree_->Fill();
}

void PrimaryVertices::Fill(const edm::Event& event)
{
