...
namespace mssmhbb {
   namespace ntuple {
      template <> void FilterEfficiency<edm::MergeableCounter>::Increment(edm::LuminosityBlock const&);
 }
}   
...
template <typename T>
FilterEfficiency<T>::~FilterEfficiency()
{
...
//
template <typename T>
FilterResults FilterEfficiency<T>::Results()
{
   FilterResults res;
...
template <typename T>
void FilterEfficiency<T>::Increment(edm::LuminosityBlock const& lumi)
{
   using namespace edm;
...
template <>
void FilterEfficiency<edm::MergeableCounter>::Increment(edm::LuminosityBlock const& lumi)
{
   using namespace edm;
...
template class FilterEfficiency<edm::MergeableCounter>;
template class FilterEfficiency<GenFilterInfo>;
