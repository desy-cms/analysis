# /users/rwalsh/run2/mssmhbb/scratch/V22 (CMSSW_7_4_0)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "TEST" )
process.load('setup_740_GRun_V34_cff')

process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/rwalsh/run2/mssmhbb/scratch/V22')
)
...
process.hltPreL1ZeroBias = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleJetC36 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltL1SingleJetC36 = cms.EDFilter( "HLTLevel1Jet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 36.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 3.0 ),
    MinMass = cms.double( -1.0 ),
    inputTag = cms.InputTag( 'hltL1extraParticles','Central' ),
    MinE = cms.double( -1.0 ),
    triggerType = cms.int32( 0 )
)
process.hltL1sL1DoubleJetC84 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_DoubleJetC84" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.hltPreL1DoubleJetC84 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltL1DoubleJetC84 = cms.EDFilter( "HLTLevel1Jet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 84.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 3.0 ),
    MinMass = cms.double( -1.0 ),
    inputTag = cms.InputTag( 'hltL1extraParticles','Central' ),
...
process.hltPreSinglePFJet20 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltSingleCentralCaloJet20 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
...
process.hltSingleCentralPFJet20 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 20.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 3.0 ),
...
process.hltPreDoublePFJet84 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltDoubleCentralCaloJet84 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 84.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 3.0 ),
...
process.hltSingleCentralPFJet84 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 84.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 3.0 ),
...
process.hltDoubleCentralPFJet84 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 84.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 3.0 ),
...
process.hltPreSinglePFJet20CaloBJetCSV0p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltCaloBJetCSV0p5L3 = cms.EDFilter( "HLTCaloJetTag",
    saveTags = cms.bool( True ),
    MinJets = cms.int32( 1 ),
...
process.hltPreSinglePFJet20PFBjetCSV0p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltBLifetimeTagInfosPF = cms.EDProducer( "TrackIPProducer",
    ...
    minimumNumberOfHits = cms.int32( 8 ),
    minimumTransverseMomentum = cms.double( 1.0 ),
    primaryVertex = cms.InputTag( "hltVerticesPFSelector" ),
    maximumLongitudinalImpactParameter = cms.double( 17.0 ),
    computeGhostTrack = cms.bool( True ),
    ghostTrackPriorDeltaR = cms.double( 0.03 ),
...
process.hltTrackVertexArbitratorPF = cms.EDProducer( "TrackVertexArbitrator",
    ...
    distCut = cms.double( 0.04 ),
    trackMinPt = cms.double( 0.4 ),
    primaryVertices = cms.InputTag( "hltVerticesPFSelector" ),
    tracks = cms.InputTag( "hltPFMuonMerging" ),
    dLenFraction = cms.double( 0.333 ),
    trackMinPixels = cms.int32( 1 ),
    dRCut = cms.double( 0.4 )
...
process.hltPFBJetCSV0p5 = cms.EDFilter( "HLTPFJetTag",
    saveTags = cms.bool( True ),
    MinJets = cms.int32( 1 ),
...
process.hltPreDoublePFJet84DoubleCaloBJetCSV0p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltDoubleCaloBJetCSV0p5L3 = cms.EDFilter( "HLTCaloJetTag",
    saveTags = cms.bool( True ),
    MinJets = cms.int32( 2 ),
    JetTags = cms.InputTag( "hltCombinedSecondaryVertexBJetTagsCalo" ),
    TriggerType = cms.int32( 86 ),
...
process.hltPreDoublePFJet84DoublePFBJetCSV0p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltDoublePFBJetCSV0p5 = cms.EDFilter( "HLTPFJetTag",
    saveTags = cms.bool( True ),
    MinJets = cms.int32( 2 ),
    JetTags = cms.InputTag( "hltCombinedSecondaryVertexBJetTagsPF" ),
    TriggerType = cms.int32( 86 ),
...
process.HLT_ZeroBias_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreL1ZeroBias + process.HLTEndSequence )
process.HLT_L1SingleJetC36_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleJet36 + process.hltPreL1SingleJetC36 + process.hltL1SingleJetC36 + process.HLTEndSequence )
process.HLT_L1DoubleJetC84_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1DoubleJetC84 + process.hltPreL1DoubleJetC84 + process.hltL1DoubleJetC84 + process.HLTEndSequence )
process.HLT_SinglePFJet20_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreSinglePFJet20 + process.HLTAK4CaloJetsSequence + process.hltSingleCentralCaloJet20 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedLooseID + process.hltSingleCentralPFJet20 + process.HLTEndSequence )
process.HLT_DoublePFJet84_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1DoubleJetC84 + process.hltPreDoublePFJet84 + process.hltL1DoubleJetC84 + process.HLTAK4CaloJetsSequence + process.hltDoubleCentralCaloJet84 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedLooseID + process.hltSingleCentralPFJet84 + process.hltDoubleCentralPFJet84 + process.HLTEndSequence )
process.HLT_SinglePFJet20_CaloBJetCSV0p5_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreSinglePFJet20CaloBJetCSV0p5 + process.HLTAK4CaloJetsSequence + process.hltSingleCentralCaloJet20 + process.HLTFastPrimaryVertexSequence + process.HLTBtagCSVSequenceL3 + process.hltCaloBJetCSV0p5L3 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedLooseID + process.hltSingleCentralPFJet20 + process.HLTEndSequence )
process.HLT_SinglePFJet20_PFBjetCSV0p5_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreSinglePFJet20PFBjetCSV0p5 + process.HLTAK4CaloJetsSequence + process.hltSingleCentralCaloJet20 + process.HLTFastPrimaryVertexSequence + process.HLTBtagCSVSequenceL3 + process.hltCaloBJetCSV0p5L3 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedLooseID + process.hltSingleCentralPFJet20 + process.HLTBtagCSVSequencePF + process.hltPFBJetCSV0p5 + process.HLTEndSequence )
process.HLT_DoublePFJet84_DoubleCaloBJetCSV0p5_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1DoubleJetC84 + process.hltPreDoublePFJet84DoubleCaloBJetCSV0p5 + process.HLTAK4CaloJetsSequence + process.hltDoubleCentralCaloJet84 + process.HLTFastPrimaryVertexSequence + process.HLTBtagCSVSequenceL3 + process.hltDoubleCaloBJetCSV0p5L3 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedLooseID + process.hltSingleCentralPFJet84 + process.hltDoubleCentralPFJet84 + process.HLTEndSequence )
process.HLT_DoublePFJet84_DoublePFBJetCSV0p5_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1DoubleJetC84 + process.hltPreDoublePFJet84DoublePFBJetCSV0p5 + process.HLTAK4CaloJetsSequence + process.hltDoubleCentralCaloJet84 + process.HLTFastPrimaryVertexSequence + process.HLTBtagCSVSequenceL3 + process.hltDoubleCaloBJetCSV0p5L3 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedLooseID + process.hltSingleCentralPFJet84 + process.hltDoubleCentralPFJet84 + process.HLTBtagCSVSequencePF + process.hltDoublePFBJetCSV0p5 + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_ZeroBias_v1, process.HLT_L1SingleJetC36_v1, process.HLT_L1DoubleJetC84_v1, process.HLT_SinglePFJet20_v1, process.HLT_DoublePFJet84_v1, process.HLT_SinglePFJet20_CaloBJetCSV0p5_v1, process.HLT_SinglePFJet20_PFBjetCSV0p5_v1, process.HLT_DoublePFJet84_DoubleCaloBJetCSV0p5_v1, process.HLT_DoublePFJet84_DoublePFBJetCSV0p5_v1, process.HLTriggerFinalPath ))
