# /users/rwalsh/run2/mssmhbb/scratch/V11 (CMSSW_7_4_0_pre9)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "TEST" )
process.load('setup_740_GRun_V31_cff')

process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/rwalsh/run2/mssmhbb/scratch/V11')
)
...
process.hltPreL1DoubleJetC112 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltCaloJetsCorrectedIDMatchedToL1 = cms.EDProducer( "HLTCaloJetL1MatchProducer",
...
process.hltDoubleCentralCaloJet84 = cms.EDFilter( "HLT1CaloJet",
    ...
    MaxEta = cms.double( 3.0 ),
    MinMass = cms.double( -1.0 ),
    inputTag = cms.InputTag( "hltCaloJetsCorrectedIDMatchedToL1" ),
    MinE = cms.double( -1.0 ),
...
process.hltPFJetsCorrectedIDMatchedToDoubleCaloJet84 = cms.EDProducer( "PFJetsMatchedToFilteredCaloJetsProducer",
    DeltaR = cms.double( 0.5 ),
    CaloJetFilter = cms.InputTag( "hltDoubleCentralCaloJet84" ),
    TriggerType = cms.int32( 86 ),
    PFJetSrc = cms.InputTag( "hltAK4PFJetsCorrectedLooseID" )
)
process.hltSingleCentralPFJet84 = cms.EDFilter( "HLT1PFJet",
    ...
    MaxEta = cms.double( 3.0 ),
    MinMass = cms.double( -1.0 ),
    inputTag = cms.InputTag( "hltPFJetsCorrectedIDMatchedToDoubleCaloJet84" ),
    MinE = cms.double( -1.0 ),
    triggerType = cms.int32( 86 )
)
...
process.HLT_ZeroBias_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreL1DoubleJetC112 + process.HLTEndSequence )
process.HLT_L1DoubleJetC84_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1DoubleJetC84 + process.hltL1DoubleJetC84 + process.hltPreL1DoubleJetC112 + process.HLTEndSequence )
process.HLT_L1DoubleJetC100_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1DoubleJetC100 + process.hltPreL1DoubleJetC112 + process.HLTEndSequence )
process.HLT_L1DoubleJetC112_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1DoubleJetC112 + process.hltPreL1DoubleJetC112 + process.HLTEndSequence )
process.HLT_DoublePFJet84_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1DoubleJetC84 + process.hltL1DoubleJetC84 + process.hltPreDoublePFJet84 + process.HLTAK4CaloJetsSequence + process.hltCaloJetsCorrectedIDMatchedToL1 + process.hltDoubleCentralCaloJet84 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedLooseID + process.hltPFJetsCorrectedIDMatchedToDoubleCaloJet84 + process.hltSingleCentralPFJet84 + process.hltDoubleCentralPFJet84 + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_ZeroBias_v1, process.HLT_L1DoubleJetC84_v1, process.HLT_L1DoubleJetC100_v1, process.HLT_L1DoubleJetC112_v1, process.HLT_DoublePFJet84_v1, process.HLTriggerFinalPath ))
