# /users/rwalsh/run2/mssmhbb/scratch/V47 (CMSSW_7_4_0)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "TEST" )
process.load('setup_740_GRun_V36_cff')
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_ZeroBias_v1, process.HLT_PFJet_BTagCSV_v1, process.HLTriggerFinalPath ))
