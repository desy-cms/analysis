# /users/rwalsh/dev/CMSSW_7_3_X/mssmhbb/V4 (CMSSW_7_3_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/rwalsh/dev/CMSSW_7_3_X/mssmhbb/V4')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/afs/desy.de/user/w/walsh/xxl-af-cms/cms/data/trigger_studies_730_mssmhbb_v4_skim.root'),
)
...
process.HLT_SingleJetX_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreSingleJetX + process.HLTAK4CaloJetsSequence + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedLooseID + process.HLTEndSequence )
