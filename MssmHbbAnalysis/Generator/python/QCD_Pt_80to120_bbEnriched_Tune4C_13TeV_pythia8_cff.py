...
generator = cms.EDFilter("Pythia8GeneratorFilter",
	...
	crossSection = cms.untracked.double(3.e06),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/work/r/rwalsh/cms/cmssw/scratch/CMSSW_7_4_0_pre9/src/MssmHbbAnalysis/Generator/python/QCD_Pt_80to120_bbEnriched_Tune4C_13TeV_pythia8_cff.py,v $'),
