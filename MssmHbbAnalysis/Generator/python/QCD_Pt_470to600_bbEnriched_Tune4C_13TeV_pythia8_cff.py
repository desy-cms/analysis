...
generator = cms.EDFilter("Pythia8GeneratorFilter",
	...
	crossSection = cms.untracked.double(5.871e02),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/work/r/rwalsh/cms/cmssw/scratch/CMSSW_7_4_0_pre9/src/MssmHbbAnalysis/Generator/python/QCD_Pt_470to600_bbEnriched_Tune4C_13TeV_pythia8_cff.py,v $'),
