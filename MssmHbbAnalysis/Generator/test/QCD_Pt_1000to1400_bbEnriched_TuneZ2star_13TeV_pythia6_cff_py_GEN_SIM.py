...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('bb-enriched QCD Pt [1000,1400] at 13 TeV'),
    name = cms.untracked.string('$Source: /afs/cern.ch/work/r/rwalsh/cms/cmssw/scratch/CMSSW_7_4_0/src/MssmHbbAnalysis/Generator/python/QCD_Pt_1000to1400_bbEnriched_TuneZ2star_13TeV_pythia6_cff.py,v $'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(8.195),
