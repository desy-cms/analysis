...
# with command line options: MssmHbbAnalysis/Generator/python/PYTHIA6_Tauola_gg_bbH160_bb_13TeV_cff.py --fileout file:gensim.root --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --datatier GEN-SIM --beamspot NominalCollision2015 --conditions auto:run2_mc --step GEN,SIM --magField 38T_PostLS1 --python_filename PYTHIA6_Tauola_gg_bbH160_bb_13TeV_cfg.py --no_exec -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('MssmHbbAnalysis/Generator/python/PYTHIA6_Tauola_gg_bbH160_bb_13TeV_cff.py nevts:10'),
