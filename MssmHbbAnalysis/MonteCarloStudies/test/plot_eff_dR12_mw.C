void plot_eff_dR12_mw()
{
   ...
   for ( int i = 0; i < 3; ++i )
   {
      h_deta[i]    = (TH1F*) fs[i] -> Get("h_R12");
      h_deta[i]    -> SetName(Form("h_dEta01_S_%i",i));
      h_deta[i+3]  = (TH1F*) fb[i] -> Get("h_R12");
...
//   leg->SetHeader("The Legend Title");
   ...
   c1 -> SaveAs("figs/j23detacut_mw_eff-"+selection+".png");
   ...
   c2 -> SaveAs("figs/j23detacut_mw_sig-"+selection+".png");
