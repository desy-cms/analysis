...
ClassImp(RooExtendNovosibirskV2)


RooExtendNovosibirskV2::RooExtendNovosibirskV2(const char *name, const char *title,
                             RooAbsReal& x,
                             RooAbsReal& peak,
                             RooAbsReal& width,
                             RooAbsReal& tail,
  ...
  par5_("par5", "par5", this, par5) {
}


RooExtendNovosibirskV2::RooExtendNovosibirskV2(const RooExtendNovosibirskV2& other, const char* name) :
  ...
  par5_("par5", this, other.par5_) {

}


TObject* RooExtendNovosibirskV2::clone(const char* newname) const {
  return new RooExtendNovosibirskV2(*this, newname);
}

/*
double RooExtendNovosibirskV2::evaluate() const {
...
{ 
  ...
  double arg = 1.0 - ( x_ - peak_ ) * tail_ / width_ - par4_ * TMath::Power( (x_ - peak_), 2) * tail_ / width_ - par5_ * TMath::Power( (x_ - peak_), 3) * tail_ / width_;
