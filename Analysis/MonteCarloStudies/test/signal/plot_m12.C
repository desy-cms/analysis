void plot_m12()
{
   TFile * f1 = new TFile("M300/genjets_susybbHtobb-M300.jpt140_jpt100_jpt30_jeta1p6_jeta1p6_jeta2p4.root");
   TFile * f2 = new TFile("M300/genjets_susybbHtobb-M300.jpt140_jpt100_jpt60_jeta2p4_jeta2p4_jeta2p4.root");
   ...
   h_m12_1 -> GetXaxis() -> SetRangeUser(100.,500.);
   ...
   c1 -> SaveAs("h300_m12_jet1cut_jet12eta_jet3cut.png");
