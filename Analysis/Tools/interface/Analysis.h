      ...
      class Analysis {
         public:
           ...
           ~Analysis();
            ...
            template<class Object>
            std::shared_ptr< PhysicsObjectTree<Object> > addTree(const std::string & unique_name, const std::string & path, const std::string & resultPath = "MssmHbb/Events/TriggerResults" );
            template<class Object>
