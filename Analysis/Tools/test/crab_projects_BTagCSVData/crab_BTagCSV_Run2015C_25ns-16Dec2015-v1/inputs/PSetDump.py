...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2015D/BTagCSV/MINIAOD/16Dec2015-v1/50000/00AF8EB4-70AB-E511-9271-00266CFAE7AC.root', 
...
process.triggerSelection = cms.EDFilter("TriggerResultsFilter",
    ...
    throw = cms.bool(True),
    triggerConditions = cms.vstring('HLT_DoubleJetsC100_DoubleBTagCSV0p85_DoublePFJetsC160_v*', 
