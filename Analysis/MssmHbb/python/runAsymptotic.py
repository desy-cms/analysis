...
if __name__ == '__main__':
    ...
    datacard_folder = '/afs/desy.de/user/s/shevchen/cms/cmssw-analysis/CMSSW_8_0_20_patch1/src/Analysis/MssmHbb/datacards/201703/08/asymptotic/mssm/'
    ...
    for m in mass:
        ...
        if m == '300' or m == '350':
            if m == '350' and combination:
                rMin = '-20'
                rMax = '30'
            combine = 'combine -M Asymptotic -t -1 --expectSignal=0 -n Hbb --rMin=' + rMin + ' --rMax=' + rMax + ' --minimizerStrategy 0 --cminFallbackAlgo "Minuit2,Minimize,0:0.1" --cminOldRobustMinimize 0 -v5'
        else:
            combine = 'combine -M Asymptotic -t -1 --expectSignal=0 -n Hbb --rMin=' + rMin + ' --rMax=' + rMax + ' -v 5'
        combine += ' ' + combine_add
