...
//   pTHat["3200toInf"] = new TFile("/afs/desy.de/user/s/shevchen/cms/cmssw-analysis/CMSSW_7_6_3/src/Analysis/MssmHbb/output/TriggerEff_lowM_QCD_Pt_3200toInf_TuneCUETP8M1_13TeV_pythia8.root");
   ...
   /**************************Trigger Objects************************/
   TCanvas *can_scat_l1pt1 = new TCanvas("can_scat_l1pt1","can_scat_l1pt1",1000,800);
   // L1 vs Offline
   can_scat_l1pt1->Divide(1,3);
   can_scat_l1pt1->cd(1);
   TH2D *h_scat_l1pt1 = (TH2D*) BgMC->Get("distributions/onlobject_turnOn_L1_pt1_vs_off");
   h_scat_l1pt1->Draw();
   TH2D *h_scat_l1pt1_b = (TH2D*) BgMC_b->Get("distributions/onlobject_turnOn_L1_pt1_vs_off");
   h_scat_l1pt1_b->SetMarkerColor(2);
   h_scat_l1pt1_b->SetLineColor(2);
   h_scat_l1pt1_b->Draw("same");
   //L2 vs Offline
   can_scat_l1pt1->cd(2);
   TH2D *h_scat_l2pt1 = (TH2D*) BgMC->Get("distributions/onlobject_turnOn_L2_pt1_vs_off");
   h_scat_l2pt1->Draw();
   TH2D *h_scat_l2pt1_b = (TH2D*) BgMC_b->Get("distributions/onlobject_turnOn_L2_pt1_vs_off");
   h_scat_l2pt1_b->SetMarkerColor(2);
   h_scat_l2pt1_b->SetLineColor(2);
   h_scat_l2pt1_b->Draw("same");
   //L3 vs Offline
   can_scat_l1pt1->cd(3);
   TH2D *h_scat_l3pt1 = (TH2D*) BgMC->Get("distributions/onlobject_turnOn_L3_pt1_vs_off");
   h_scat_l3pt1->Draw();
   TH2D *h_scat_l3pt1_b = (TH2D*) BgMC_b->Get("distributions/onlobject_turnOn_L3_pt1_vs_off");
   h_scat_l3pt1_b->SetMarkerColor(2);
   h_scat_l3pt1_b->SetLineColor(2);
   h_scat_l3pt1_b->Draw("same");

   /*************************pT**********************************/

   TCanvas * can_pt_comp = new TCanvas("can_pt_comp","can_pt_comp",1000,800);			// All jets
   can_pt_comp->Divide(1,2);
   can_pt_comp->cd(1);
   TLegend * leg_pt_comp = new TLegend(0.5,0.5,0.75,0.75);
   leg_pt_comp->SetHeader("All Jets");
   TH1D *h_l1_pt1 	= (TH1D*) BgMC->Get("distributions/onlobject_turnOn_L1_pt1");
   h_l1_pt1->Scale(1./h_l1_pt1->Integral());
   h_l1_pt1->SetMarkerStyle(20);
   h_l1_pt1->SetMarkerColor(5);
   leg_pt_comp->AddEntry(h_l1_pt1,"L1","p");
   TH1D *h_l2_pt1 	= (TH1D*) BgMC->Get("distributions/onlobject_turnOn_L2_pt1");
   h_l2_pt1->Scale(1./h_l2_pt1->Integral());
   h_l2_pt1->SetMarkerStyle(20);
   h_l2_pt1->SetMarkerColor(2);
   leg_pt_comp->AddEntry(h_l2_pt1,"L2","p");
   TH1D *h_l3_pt1 	= (TH1D*) BgMC->Get("distributions/onlobject_turnOn_L3_pt1");
   h_l3_pt1->Scale(1./h_l3_pt1->Integral());
   h_l3_pt1->SetMarkerStyle(20);
   h_l3_pt1->SetMarkerColor(3);
   leg_pt_comp->AddEntry(h_l3_pt1,"L3","p");
   TH1D *h_gen_pt1	= (TH1D*) BgMC->Get("distributions/Genjet_turnOn_pt1");
   h_gen_pt1->Scale(1./h_gen_pt1->Integral());
   h_gen_pt1->SetMarkerStyle(20);
   h_gen_pt1->SetMarkerColor(4);
   leg_pt_comp->AddEntry(h_gen_pt1,"Gen","p");
   TH1D *h_pt1 		= (TH1D*) BgMC->Get("distributions/jet_turnOn_pt1");
   h_pt1->Scale(1./h_pt1->Integral());
   h_pt1->SetMarkerStyle(20);
   h_pt1->SetMarkerColor(1);
   leg_pt_comp->AddEntry(h_pt1,"Offline","p");
   h_pt1->Draw("E");
   h_l1_pt1->Draw("E same");
   h_l2_pt1->Draw("E same");
   h_l3_pt1->Draw("E same");
   h_gen_pt1->Draw("E same");
   leg_pt_comp->Draw();

   can_pt_comp->cd(2);																		// b Jets
   TLegend * leg_pt_comp_b = new TLegend(0.5,0.5,0.75,0.75);
   leg_pt_comp_b->SetHeader("b Jets");
   TH1D *h_l1_pt1_b 	= (TH1D*) BgMC_b->Get("distributions/onlobject_turnOn_L1_pt1");
   h_l1_pt1_b->Scale(1./h_l1_pt1_b->Integral());
   h_l1_pt1_b->SetMarkerStyle(22);
   h_l1_pt1_b->SetMarkerColor(5);
   leg_pt_comp_b->AddEntry(h_l1_pt1_b,"L1","p");
   TH1D *h_l2_pt1_b 	= (TH1D*) BgMC_b->Get("distributions/onlobject_turnOn_L2_pt1");
   h_l2_pt1_b->Scale(1./h_l2_pt1_b->Integral());
   h_l2_pt1_b->SetMarkerStyle(22);
   h_l2_pt1_b->SetMarkerColor(2);
   leg_pt_comp_b->AddEntry(h_l2_pt1_b,"L2","p");
   TH1D *h_l3_pt1_b 	= (TH1D*) BgMC_b->Get("distributions/onlobject_turnOn_L3_pt1");
   h_l3_pt1_b->Scale(1./h_l3_pt1_b->Integral());
   h_l3_pt1_b->SetMarkerStyle(22);
   h_l3_pt1_b->SetMarkerColor(3);
   leg_pt_comp_b->AddEntry(h_l3_pt1_b,"L3","p");
   TH1D *h_gen_pt1_b	= (TH1D*) BgMC_b->Get("distributions/Genjet_turnOn_pt1");
   h_gen_pt1_b->Scale(1./h_gen_pt1_b->Integral());
   h_gen_pt1_b->SetMarkerStyle(22);
   h_gen_pt1_b->SetMarkerColor(4);
   leg_pt_comp_b->AddEntry(h_gen_pt1_b,"Gen","p");
   TH1D *h_pt1_b 		= (TH1D*) BgMC_b->Get("distributions/jet_turnOn_pt1");
   h_pt1_b->Scale(1./h_pt1_b->Integral());
   h_pt1_b->SetMarkerStyle(22);
   h_pt1_b->SetMarkerColor(1);
   leg_pt_comp_b->AddEntry(h_pt1_b,"Offline","p");
   h_pt1_b->Draw("E");
   h_l1_pt1_b->Draw("E same");
   h_l2_pt1_b->Draw("E same");
   h_l3_pt1_b->Draw("E same");
   h_gen_pt1_b->Draw("E same");
   leg_pt_comp_b->Draw();

   TCanvas * can_pt_comp_1by1_1 = new TCanvas("can_pt_comp_1by1_1","can_pt_comp_1by1",1000,800);
   TH1D *r_pt1_l1 = (TH1D*) ratio.DrawRatio(h_l1_pt1,(TH1D*)h_l1_pt1_b->Clone(),can_pt_comp_1by1_1);
   TCanvas * can_pt_comp_1by1_2 = new TCanvas("can_pt_comp_1by1_2","can_pt_comp_1by2",1000,800);
   TH1D *r_pt1_l2 = (TH1D*) ratio.DrawRatio(h_l2_pt1,(TH1D*)h_l2_pt1_b->Clone(),can_pt_comp_1by1_2);
   TCanvas * can_pt_comp_1by1_3 = new TCanvas("can_pt_comp_1by1_3","can_pt_comp_1by3",1000,800);
   TH1D *r_pt1_l3 = (TH1D*) ratio.DrawRatio(h_l3_pt1,(TH1D*)h_l3_pt1_b->Clone(),can_pt_comp_1by1_3);
   TCanvas * can_pt_comp_1by1_4 = new TCanvas("can_pt_comp_1by1_4","can_pt_comp_1by4",1000,800);
   TH1D *r_pt1_gen = (TH1D*) ratio.DrawRatio(h_gen_pt1,(TH1D*)h_gen_pt1_b->Clone(),can_pt_comp_1by1_4);
   TCanvas * can_pt_comp_1by1_5 = new TCanvas("can_pt_comp_1by1_5","can_pt_comp_1by5",1000,800);
   TH1D *r_pt1 = (TH1D*) ratio.DrawRatio(h_pt1,(TH1D*)h_pt1_b->Clone(),can_pt_comp_1by1_5);

   /***************************eta********************************/

   TCanvas *can_eta1_comp = new TCanvas("can_eta1_comp","can_eta1_comp",1000,800);
   can_eta1_comp->Divide(1,2);
   can_eta1_comp->cd(1);
   TLegend * leg_eta_comp = new TLegend(0.5,0.5,0.75,0.75);
   leg_eta_comp->SetHeader("All Jets");
   TH1D *h_l1_eta1 	= (TH1D*) BgMC->Get("distributions/onlobject_L1_eta1");
   h_l1_eta1->Scale(1./h_l1_eta1->Integral());
   h_l1_eta1->SetMarkerStyle(20);
   h_l1_eta1->SetMarkerColor(5);
   leg_eta_comp->AddEntry(h_l1_eta1,"L1","p");
   TH1D *h_l2_eta1 	= (TH1D*) BgMC->Get("distributions/onlobject_L2_eta1");
   h_l2_eta1->Scale(1./h_l2_eta1->Integral());
   h_l2_eta1->SetMarkerStyle(20);
   h_l2_eta1->SetMarkerColor(2);
   leg_eta_comp->AddEntry(h_l2_eta1,"L2","p");
   TH1D *h_l3_eta1 	= (TH1D*) BgMC->Get("distributions/onlobject_L3_eta1");
   h_l3_eta1->Scale(1./h_l3_eta1->Integral());
   h_l3_eta1->SetMarkerStyle(20);
   h_l3_eta1->SetMarkerColor(3);
   leg_eta_comp->AddEntry(h_l3_eta1,"L3","p");
   TH1D *h_gen_eta1	= (TH1D*) BgMC->Get("distributions/Genjet_eta1");
   h_gen_eta1->Scale(1./h_gen_eta1->Integral());
   h_gen_eta1->SetMarkerStyle(20);
   h_gen_eta1->SetMarkerColor(4);
   leg_eta_comp->AddEntry(h_gen_eta1,"Gen","p");
   TH1D *h_eta1 		= (TH1D*) BgMC->Get("distributions/jet_eta1");
   h_eta1->Scale(1./h_eta1->Integral());
   h_eta1->SetMarkerStyle(20);
   h_eta1->SetMarkerColor(1);
   leg_eta_comp->AddEntry(h_eta1,"Offline","p");
   h_eta1->Draw("E");
   h_l1_eta1->Draw("E same");
   h_l2_eta1->Draw("E same");
   h_l3_eta1->Draw("E same");
   h_gen_eta1->Draw("E same");
   leg_eta_comp->Draw();

   can_eta1_comp->cd(2);																		// b Jets
   TLegend * leg_eta_comp_b = new TLegend(0.5,0.5,0.75,0.75);
   leg_eta_comp_b->SetHeader("b Jets");
   TH1D *h_l1_eta1_b 	= (TH1D*) BgMC_b->Get("distributions/onlobject_L1_eta1");
   h_l1_eta1_b->Scale(1./h_l1_eta1_b->Integral());
   h_l1_eta1_b->SetMarkerStyle(22);
   h_l1_eta1_b->SetMarkerColor(5);
   leg_eta_comp_b->AddEntry(h_l1_eta1_b,"L1","p");
   TH1D *h_l2_eta1_b 	= (TH1D*) BgMC_b->Get("distributions/onlobject_L2_eta1");
   h_l2_eta1_b->Scale(1./h_l2_eta1_b->Integral());
   h_l2_eta1_b->SetMarkerStyle(22);
   h_l2_eta1_b->SetMarkerColor(2);
   leg_eta_comp_b->AddEntry(h_l2_eta1_b,"L2","p");
   TH1D *h_l3_eta1_b 	= (TH1D*) BgMC_b->Get("distributions/onlobject_L3_eta1");
   h_l3_eta1_b->Scale(1./h_l3_eta1_b->Integral());
   h_l3_eta1_b->SetMarkerStyle(22);
   h_l3_eta1_b->SetMarkerColor(3);
   leg_eta_comp_b->AddEntry(h_l3_eta1_b,"L3","p");
   TH1D *h_gen_eta1_b	= (TH1D*) BgMC_b->Get("distributions/Genjet_eta1");
   h_gen_eta1_b->Scale(1./h_gen_eta1_b->Integral());
   h_gen_eta1_b->SetMarkerStyle(22);
   h_gen_eta1_b->SetMarkerColor(4);
   leg_eta_comp_b->AddEntry(h_gen_eta1_b,"Gen","p");
   TH1D *h_eta1_b 		= (TH1D*) BgMC_b->Get("distributions/jet_eta1");
   h_eta1_b->Scale(1./h_eta1_b->Integral());
   h_eta1_b->SetMarkerStyle(22);
   h_eta1_b->SetMarkerColor(1);
   leg_eta_comp_b->AddEntry(h_eta1_b,"Offline","p");
   h_eta1_b->Draw("E");
   h_l1_eta1_b->Draw("E same");
   h_l2_eta1_b->Draw("E same");
   h_l3_eta1_b->Draw("E same");
   h_gen_eta1_b->Draw("E same");
   leg_eta_comp_b->Draw();

   TCanvas * can_eta_comp_1by1_1 = new TCanvas("can_eta_comp_1by1_1","can_eta_comp_1by1_1",1000,800);
   TH1D *r_eta1_l1 = (TH1D*) ratio.DrawRatio(h_l1_eta1,(TH1D*)h_l1_eta1_b->Clone(),can_eta_comp_1by1_1);
   TCanvas * can_eta_comp_1by1_2 = new TCanvas("can_eta_comp_1by1_2","can_eta_comp_1by1_2",1000,800);
   TH1D *r_eta1_l2 = (TH1D*) ratio.DrawRatio(h_l2_eta1,(TH1D*)h_l2_eta1_b->Clone(),can_eta_comp_1by1_2);
   TCanvas * can_eta_comp_1by1_3 = new TCanvas("can_eta_comp_1by1_3","can_eta_comp_1by1_3",1000,800);
   TH1D *r_eta1_l3 = (TH1D*) ratio.DrawRatio(h_l3_eta1,(TH1D*)h_l3_eta1_b->Clone(),can_eta_comp_1by1_3);
   TCanvas * can_eta_comp_1by1_4 = new TCanvas("can_eta_comp_1by1_4","can_eta_comp_1by1_4",1000,800);
   TH1D *r_eta1_gen = (TH1D*) ratio.DrawRatio(h_gen_eta1,(TH1D*)h_gen_eta1_b->Clone(),can_eta_comp_1by1_4);
   ...
   h_ratio_l1->SetMarkerStyle(20);
   h_ratio_l1->SetMarkerColor(1);
   TH1D *h_ratio_l1_b	= (TH1D*) BgMC_b->Get("distributions/onlobject_turnOn_L1ovOff_pt1");
   ...
   h_ratio_l2->Scale(1./h_ratio_l2->Integral());
   h_ratio_l2->SetMarkerStyle(20);
   h_ratio_l2->SetMarkerColor(1);
   TH1D *h_ratio_l2_b	= (TH1D*) BgMC_b->Get("distributions/onlobject_turnOn_L2ovOff_pt1");
   ...
   h_ratio_l3->Scale(1./h_ratio_l3->Integral());
   h_ratio_l3->SetMarkerStyle(20);
   h_ratio_l3->SetMarkerColor(1);
   TH1D *h_ratio_l3_b	= (TH1D*) BgMC_b->Get("distributions/onlobject_turnOn_L3ovOff_pt1");
...
//	   pf100Eff_signal_mc[i] = (TH1D*) f.second->Get("TriggerEfficiencies/KinTrigEff_1D_Pf80_Pf100_pt1");
  ...
  leg_bg_qcd_comp->Draw();
  /*TGraphAsymmErrors *ratio_b_notb = (TGraphAsymmErrors*)ratio.DrawRatio(pf100Eff_qcd->GetPaintedGraph(),pf100Eff_qcd_true_b->GetPaintedGraph(),can_bg_comp);
   *
   *
   */
