...
//        - ... 
#define mssm_xs_tools_8tev_cxx
#include "TH2F.h"
#include "mssm_xs_tools_8TeV.h"
#include <iostream>
mssm_xs_tools_8tev::mssm_xs_tools_8tev(){
...
void mssm_xs_tools_8tev::SetInput(const char* filename){
...
//BR (this could be extended easily)
Double_t mssm_xs_tools_8tev::Give_BR_A_bb(Double_t mA, Double_t tanb){
  int gbin=m_h_brbb_A->FindBin(mA,tanb);
  return m_h_brbb_A->GetBinContent(gbin);
}
Double_t mssm_xs_tools_8tev::Give_BR_H_bb(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_BR_A_tautau(Double_t mA, Double_t tanb){
  int gbin=m_h_brtautau_A->FindBin(mA,tanb);
  return m_h_brtautau_A->GetBinContent(gbin);
}
Double_t mssm_xs_tools_8tev::Give_BR_H_tautau(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_BR_A_mumu(Double_t mA, Double_t tanb){
  int gbin=m_h_brmumu_A->FindBin(mA,tanb);
  return m_h_brmumu_A->GetBinContent(gbin);
}
Double_t mssm_xs_tools_8tev::Give_BR_H_mumu(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_BR_H_hh(Double_t mA, Double_t tanb){
  int gbin=m_h_brh0h0_H->FindBin(mA,tanb);
  return m_h_brh0h0_H->GetBinContent(gbin);
}

Double_t mssm_xs_tools_8tev::Give_BR_A_Zh(Double_t mA, Double_t tanb){
...
//mass
Double_t mssm_xs_tools_8tev::Give_Mass_h(Double_t mA, Double_t tanb){
...
//bbH5f
Double_t mssm_xs_tools_8tev::Give_Xsec_bbA5f(Double_t mA, Double_t tanb){
  int gbin=m_h_bbH_xsec_A->FindBin(mA,tanb);
  return m_h_bbH_xsec_A->GetBinContent(gbin);
}
Double_t mssm_xs_tools_8tev::Give_Xsec_bbh5f(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_muup_bbA5f(Double_t mA, Double_t tanb){ //up=scale0.5
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_muup_bbh5f(Double_t mA, Double_t tanb){ //up=scale0.5
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_mudown_bbA5f(Double_t mA, Double_t tanb){ //down=scale2.0
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_mudown_bbh5f(Double_t mA, Double_t tanb){ //down=scale2.0
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdf68up_bbA5f(Double_t mA, Double_t tanb){
  int gbin=m_h_bbH_pdf68up_A->FindBin(mA,tanb);
  return m_h_bbH_pdf68up_A->GetBinContent(gbin);
}
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdf68up_bbh5f(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdf68down_bbA5f(Double_t mA, Double_t tanb){
  int gbin=m_h_bbH_pdf68down_A->FindBin(mA,tanb);
  return (-1.)*m_h_bbH_pdf68down_A->GetBinContent(gbin);
}
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdf68down_bbh5f(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdfalphas68up_bbA5f(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdfalphas68up_bbh5f(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdfalphas68down_bbA5f(Double_t mA, Double_t tanb){
  int gbin=m_h_bbH_pdfalphas68up_A->FindBin(mA,tanb);
  double alphasval=m_h_bbH_pdfalphas68up_A->GetBinContent(gbin);
  gbin=m_h_bbH_pdf68up_A->FindBin(mA,tanb);
  double pdfval=m_h_bbH_pdf68up_A->GetBinContent(gbin);
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdfalphas68down_bbh5f(Double_t mA, Double_t tanb){
...
//bbH4f
Double_t mssm_xs_tools_8tev::Give_Xsec_bbA4f(Double_t mA, Double_t tanb){
  int gbin=m_h_bbH4f_xsec_A->FindBin(mA,tanb);
  return m_h_bbH4f_xsec_A->GetBinContent(gbin);
}
Double_t mssm_xs_tools_8tev::Give_Xsec_bbH4f(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_mudown_bbA4f(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_mudown_bbh4f(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_muup_bbA4f(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_muup_bbh4f(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_Xsec_ggFA(Double_t mA, Double_t tanb){
  int gbin=m_h_ggF_xsec_A->FindBin(mA,tanb);
  return m_h_ggF_xsec_A->GetBinContent(gbin);
}
Double_t mssm_xs_tools_8tev::Give_Xsec_ggFH(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_muup_ggFA(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_muup_ggFH(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_mudown_ggFA(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_mudown_ggFH(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdf68up_ggFA(Double_t mA, Double_t tanb){
  int gbin=m_h_ggF_pdfup_A->FindBin(mA,tanb);
  return m_h_ggF_pdfup_A->GetBinContent(gbin);
}
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdf68up_ggFH(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdf68down_ggFA(Double_t mA, Double_t tanb){
  int gbin=m_h_ggF_pdfdown_A->FindBin(mA,tanb);
  return (-1.)*m_h_ggF_pdfdown_A->GetBinContent(gbin);
}
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdf68down_ggFH(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdfalphas68up_ggFA(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdfalphas68up_ggFH(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdfalphas68down_ggFA(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::Give_XsecUnc_pdfalphas68down_ggFH(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::GiveXsec_Santander_h(Double_t mA, Double_t tanb){
...
Double_t mssm_xs_tools_8tev::GiveXsec_Santander_A(Double_t mA, Double_t tanb){
  double mh=mA;
  double t=log(mh/4.75)-2.;
...
Double_t mssm_xs_tools_8tev::GiveXsec_UncUp_Santander_H(Double_t mA, Double_t tanb){
   double mh=this->Give_Mass_H(mA,tanb);
   double t=log(mh/4.75)-2.;
   // scale unc. for 4f:
...
Double_t mssm_xs_tools_8tev::GiveXsec_UncUp_Santander_A(Double_t mA, Double_t tanb){
  double mh=mA;
   double t=log(mh/4.75)-2.;
   // scale unc. for 4f:
...
Double_t mssm_xs_tools_8tev::GiveXsec_UncDown_Santander_H(Double_t mA, Double_t tanb){
   double mh=this->Give_Mass_H(mA,tanb);
   double t=log(mh/4.75)-2.;
   // scale unc. for 4f:
...
Double_t mssm_xs_tools_8tev::GiveXsec_UncDown_Santander_A(Double_t mA, Double_t tanb){
  double mh=mA;
   double t=log(mh/4.75)-2.;
   // scale unc. for 4f:
