 ...
 */
   ...
   TH1F *mcModel_Num = new TH1F("mcModel_Num","True MC J1 dPhi<2.7",200,0.,500.);
   ...
   TF1 *fitJ1mc = new TF1("fitJ1mc",finaleFunction,90,500,4);
   fitJ1mc -> SetParameters(8.87953e-02,1.01088e+02,1.83385e-01,9.98029e+01);
   fitJ1mc ->SetLineColor(2);
   mcModel_Num ->Fit("fitJ1mc","R+");
   std::cout<<" Chi2/ndf = "<<fitJ1mc->GetChisquare()/fitJ1mc->GetNDF()<<std::endl;
   mcModel_Num ->SetMarkerStyle(20);
   mcModel_Num ->SetMarkerColor(2);

   //Second L jet
   TH1F *mcModel_NumJ2 = new TH1F("mcModel_NumJ2","True MC J2 dPhi<2.7",200,0.,500.);
   mcTree ->Draw("mcModel_Num[1]>>mcModel_NumJ2",weightLumi*cut,"E");
   TH1F *mcModel_DenumJ2 = new TH1F("mcModel_DenumJ2","True MC Method",200,0.,500.);
   mcTree ->Draw("mcModel_Denum[1]>>mcModel_DenumJ2",weightLumi*cut,"E");
   mcModel_NumJ2 ->Divide(mcModel_NumJ2, mcModel_DenumJ2,1.,1.,"b");
   TF1 *fitJ2mc = new TF1("fitJ2mc",finaleFunction,90,500,4);
   fitJ2mc -> SetParameters(8.87953e-02,1.01088e+02,1.83385e-01,9.98029e+01);
   fitJ2mc -> SetLineColor(1);
   mcModel_NumJ2 ->Fit("fitJ2mc","R+");
   std::cout<<" Chi2/ndf = "<<fitJ2mc->GetChisquare()/fitJ2mc->GetNDF()<<std::endl;
   mcModel_NumJ2 ->SetMarkerStyle(21);
   mcModel_NumJ2 ->SetMarkerColor(1);
   drawRatio(mcModel_Num,mcModel_NumJ2,canva6MC);
   ...
   mcTree ->Draw("LeadPt[0] >> pt1RefRewMC",(cutPFJet80Match+cut)*cutRefRew*weightLumi,"E");
   ...
   mcTree->Draw("LeadPt[0] >> pt1PF100MatchMC",(cutPfJet100Match+cut)*weightLumi,"E same");
   gPad->SetLogy();
