...
int DataVSData(){
   ...
   TFile * fMC1 = new TFile("/nfs/dust/cms/user/shevchen/output/DoubleBTagSelection_HighMass_Tsamples_14_02_2016.root");
   TFile * fMC2 = new TFile("/nfs/dust/cms/user/shevchen/output/DoubleBTagSelection_HighMass_T_Low_samples_14_02_2016.root");
   ...
   //..............................Pt1 ....................
    ...
    mc1Tree ->Draw("LeadPt[0]>>fLeadPtMC","LeadPt[0] > 250 && LeadPt[1] > 200 && abs(LeadEta[0] - LeadEta[1]) < 1.4 && LeadBTag[0] > 0.97 && LeadBTag[1] > 0.97","E");
    mc2Tree ->Draw("LeadPt[0]>>fLeadPtMCnew","LeadPt[0] > 250 && LeadPt[1] > 200 && LeadBTag[0] > 0.97 && LeadBTag[1] > 0.97 && abs(LeadEta[0] - LeadEta[1]) < 1.4","E");
