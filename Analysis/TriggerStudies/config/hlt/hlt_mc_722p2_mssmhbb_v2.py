# /users/rwalsh/dev/CMSSW_7_2_X/mssmhbb/V2 (CMSSW_7_2_2_patch2)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "TEST" )

process.load("setup_722p2_grun_v69_cff")

process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/rwalsh/dev/CMSSW_7_2_X/mssmhbb/V2')
)
...
process.hltPreSingleJetX = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('trigger_studies_skim.root'),
)
...
process.HLT_SingleJetX_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreSingleJetX + process.HLTAK4CaloJetsSequence + process.HLTFastPrimaryVertexSequence + process.HLTBtagCSVSequenceL3 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedLooseID + process.HLTEndSequence )
